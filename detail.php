...
<div class="detail" style="padding-top:10px">
    <div class="row">
        <div class="col-md-5">
            <img style="height:340px" class="img-responsive" src="public/image/<?php echo $value_detail['image'] ?>"
                alt="">
        </div>
        <div class="col-md-7">
    ...
    <div class="row">
        ...
        <?php
            ...
            $db = new Db();
            $sql = "SELECT * FROM comment WHERE id_products = '$id'";
        ...
        <div class="col-md-12">
            <div class="comment">
                ...
                <div class="col-xs-9 col-md-11">
                    ...
                    <div>
                        <span style="color: #FF5622;"><?php echo  $value_comment['name'] ?></span> -
                        <?php echo $value_comment['created_at'] ?>
                    </div>
